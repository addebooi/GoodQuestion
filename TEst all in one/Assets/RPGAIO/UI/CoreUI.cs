...
public class CoreUI : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        _classDefinition = Rm_RPGHandler.Instance.Player.ClassDefinitions.First(c => c.ID == playerChar.PlayerClassID);
	...
	void Update ()
	{
        ...
        PlayerModel.NameAndLevel.text = playerChar.Name + " - " + "Level " + playerChar.Level;
	}
}
