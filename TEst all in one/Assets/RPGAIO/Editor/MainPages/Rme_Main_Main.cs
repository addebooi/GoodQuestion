...
namespace LogicSpawn.RPGMaker.Editor
{
    public static class Rme_Main_Main
    {
        ...
        private static Texture2D PictureB = PictureB ?? Resources.Load("RPGMakerAssets/sampleImageB") as Texture2D;
        ...
        public static void Home(Rect fullArea, Rect leftArea, Rect mainArea)
        {
            ...
            GUILayout.Box("LogicSpawn RPG All-In-One v1.0.0", "mainTitleCenter");
            ...
            {
                Application.OpenURL("https://www.youtube.com/playlist?list=PLgDkDr4naeh-G1aingqNF_v9dL3kMnxPG");
            }
            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginVertical(GUILayout.MaxWidth(250));
            GUILayout.Label("Getting Started", "homePageText", GUILayout.Width(250));
            GUILayout.Box(PictureB, "genericButton", GUILayout.Height(250), GUILayout.Width(250));

            GUILayout.Label("Check out how to get started with the RPG maker.",
                            "homePageText", GUILayout.Width(250), GUILayout.Height(75));
            if (GUILayout.Button("Get Started Now", "genericButton", GUILayout.Width(250)))
            {
                Application.OpenURL("http://www.logicspawn.co.uk/products/RPGCreationTool");
            }
            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginVertical(GUILayout.MaxWidth(250));
            GUILayout.Label("Sample Projects", "homePageText", GUILayout.Width(250));
            GUILayout.Box(PictureC, "genericButton", GUILayout.Height(250), GUILayout.Width(250));

            GUILayout.Label("Don't know where to start? Import one of our example projects.",
                            "homePageText", GUILayout.Width(250), GUILayout.Height(75));
            GUILayout.Button("Example Games", "genericButton", GUILayout.Width(250));
            GUILayout.FlexibleSpace();
        ...
        public static void GameSettings(Rect fullArea, Rect leftArea, Rect mainArea)
        {
            ...
            Settings.DefaultGraphics.FullScreen = RPGMakerGUI.Toggle("Fullscreen:",
                                                                         Settings.DefaultGraphics.FullScreen);
            Settings.DefaultGraphics.QualityLevel = RPGMakerGUI.Popup("Quality Level:",
                                                                          Settings.DefaultGraphics.QualityLevel,
