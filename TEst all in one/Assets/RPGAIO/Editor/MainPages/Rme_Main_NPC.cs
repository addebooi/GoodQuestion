        ...
        public static void NPCs(Rect fullArea, Rect leftArea, Rect mainArea)
        {
            ...
            if (selectedCharInfo != null)
            {
                ...
                if (RPGMakerGUI.Foldout(ref mainInfoFoldout, "Main Info"))
                {
                    ...
                    if (GUILayout.Button("Create NPC Object", "genericButton", GUILayout.MaxHeight(30)))
                    {
                        ...
                        var npcSpawned = GameObject.Instantiate(Resources.Load("RPGMakerAssets/NpcTemplate"), spawnPos, Quaternion.identity) as GameObject;
                        npcSpawned.GetComponent<NpcCharacterMono>().NpcID = selectedCharInfo.ID;
                    }
