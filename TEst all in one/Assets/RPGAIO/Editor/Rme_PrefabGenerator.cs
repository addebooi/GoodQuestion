        ...
        public static string GeneratePrefab(Rmh_PrefabType prefabType, SkillType? skillType = null, string param = "")
        {
            ...
            switch(prefabType)
            {
                ...
                case Rmh_PrefabType.NPC:
                    ...
                    rpgC.cameraMode = CameraMode.Standard;
            ...
            else if(prefabType == Rmh_PrefabType.NPC || prefabType == Rmh_PrefabType.Enemy)
            {
                ...
                combatantUi.HealthBar = graphic.transform.FindChild("HealthBar").GetComponent<Image>();
                combatantUi.HealthText = graphic.transform.FindChild("HealthText").GetComponent<Text>();
