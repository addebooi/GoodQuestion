...
using UnityEditor;
    ...
    public class Rme_Main : EditorWindow
    {
        ...
        public string[] GamePages = new[] { "Options", "Game Info", "Settings and Controls", "Save Options", "Credits", "Global Playlist", "World Map" };
        public string[] StatsPages = new[] { "Options", "Attributes", "Vitals", "Statistics", "Traits", "Experience" };
        public string[] PlayerPages = new[] {"Options","Classes"};
        ...
        private void OnGUIx()
        {
            ...
            GUILayout.Label("","LogicSpawnIcon");
            GUILayout.Label("RPG All-In-One v1.0.0");
            ...
            switch(CurrentPage)
            {
                ...
                case CurrentPage.Player:
                    ...
                    else if (CurrentPageIndex == Array.IndexOf(PlayerPages, "Classes"))
                    {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            if(GUILayout.Button("New Data","genericButton"))
            {
