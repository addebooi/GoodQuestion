...
namespace LogicSpawn.RPGMaker
{
    public class Rmh_Experience
    {
        ...
        public int ExpToNextPlayerLevel(string definitionId, int currentPlayerLevel)
        {
        ...
        public int ExpToNextPlayerTraitLevel(string definitionId, int currentTraitLevel)
        {
    ...
    public class ExpDefinition
    {
        ...
        public string Name;
        public int MaxLevel;
        public int XpForFirstLevel; //not for linear OR LINEARRISE
        ...
        public int ExpForLevel(int currentLevel)
        {
            Func<int, int> expForLevel;
        ...
        private int ExpForLevelLinearRise(int currentLevel)
        {
            var xpForFirst = XpForFirstLevel - Constant;

            currentLevel++;
            var experience = (int)((Math.Pow(currentLevel, 2) + currentLevel) / 2 * Constant - (currentLevel * Constant)) + (currentLevel * xpForFirst);
            return experience;
        }

        private int ExpForLevelLinear(int currentLevel)
        {
