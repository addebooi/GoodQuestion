    ...
    public class NodeChainObjectNode : PropertyNode
    {
        ...
        public override object EvaluateInput(NodeChain nodeChain, Func<object, object> func)
        {
            if(func != null)
            {
                ...
                {
                    Debug.LogError("[RPGMaker] Error accessing/modifying node chain object value. You may be attempting to access a different type, or a list instead of a singular object.");
                    throw;
                }
