...
namespace LogicSpawn.RPGMaker.Core
{
    ...
    public class Skill
    {
        ...
        public bool Learnt ; //Learnt means can use
        ...
        public Damage Damage { 
            get
            {
                ...
                var damage = CombatCalcEvaluator.EvaluateSkillDamage(DamageScalingTreeID,SkillStatistics[CurrentRank].Damage,Caster);
                return damage;
            } 
        }
        ...
        private string GetFormattedSkillDescription()
        {
            ...
            for (int i = 0; i < Rm_RPGHandler.Instance.ASVT.VitalDefinitions.Count; i++)
            {
                ...
                text = text.Replace("{Vital_" + attr.Name + "_Regen" + "}", playerSave == null ? "VAL" : playerSave.Character.GetVital(attr.Name).RegenPercentValue.ToString());
            }
        ...
        public bool CanUnlock(PlayerCharacter player)
        {
            ...
            if(!string.IsNullOrEmpty(PreviousSkillID))
            {
                ...
                var hasPreviousSkill = firstOrDefault != null && firstOrDefault.Learnt;
