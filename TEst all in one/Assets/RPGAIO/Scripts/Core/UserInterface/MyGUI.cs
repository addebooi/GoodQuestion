...
//        {
//            get { return Rm_RPGHandler.Instance.Player.ClassDefinitions.First(c => c.ID == Player.PlayerClassID); }
//        }
//
...
//                                    Player.Name, Player.Level, Player.Exp, RPG.Player.GetClassName(Player.PlayerClassID)) + "\n";
//            
//            foreach(var attr in Player.Attributes)
//            {
//                var attrName = RPG.Stats.GetAttributeName(attr.ID);
