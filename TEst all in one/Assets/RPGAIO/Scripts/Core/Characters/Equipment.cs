...
namespace LogicSpawn.RPGMaker.Core
{
    public class Equipment
    {
        ...
        public void UpdateDynamicItems()
        {
            ...
            var classDef = Rm_RPGHandler.Instance.Player.ClassDefinitions.First(c => c.ID == Player.PlayerClassID);
        ...
        private EquipResult EquipItem(Weapon weapon)
        {
            ...
            if (Rm_RPGHandler.Instance.Items.LimitItemsToClass && !weapon.AllClasses && weapon.ClassIDs.FirstOrDefault(c => c == Player.PlayerClassID) == null ) return EquipResult.WrongClass;
        ...
        private EquipResult EquipItem(Apparel apparel)
        {
            ...
            if (Rm_RPGHandler.Instance.Items.LimitItemsToClass && !apparel.AllClasses && apparel.ClassIDs.FirstOrDefault(c => c == Player.PlayerClassID) == null) return EquipResult.WrongClass;
