...
namespace LogicSpawn.RPGMaker.Core
{
    ...
    public class Inventory
    {
        ...
        public Inventory()
        {
            ...
            MaxWeight = Rm_RPGHandler.Instance.Items.MaxWeight;
        ...
        {
            return CanAddItems(new List<Item> {item});
        }
        ...
        public bool CanAddItems(List<Item> items)
        {
            ...
            if(!hasMaxItems)
            {
                canAdd = GetCurrentWeight() + totalWeight <= MaxWeight;
