...
namespace LogicSpawn.RPGMaker.Core
{
    ...
    public class PlayerSave
    {
        ...
        public PlayerSave(string saveName, string classID, string charName, string startingScene)
        {
#if UNITY_WEBPLAYER
            ...
            SaveName = saveName;
            Character = new PlayerCharacter(classID, charName);
        ...
        public void Initialize()
        {
            ...
            var classDef = Rm_RPGHandler.Instance.Player.ClassDefinitions.First(c => c.ID == Character.PlayerClassID);
        ...
        {
            var details = "";
            var classes = Rm_RPGHandler.Instance.Player.ClassDefinitions;
            var className = classes.FirstOrDefault(c => c.ID == Character.PlayerClassID);
