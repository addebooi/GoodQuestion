...
namespace LogicSpawn.RPGMaker.Core
{
    public class QuestLog
    {
        ...
        public void Init()
        {
            ...
            AllObjectives.AddRange(Rm_RPGHandler.Instance.Repositories.Quests.AllSingleQuests);
            AllObjectives.AddRange(Rm_RPGHandler.Instance.Repositories.Quests.AllQuestChains.SelectMany(q => q.QuestsInChain));
