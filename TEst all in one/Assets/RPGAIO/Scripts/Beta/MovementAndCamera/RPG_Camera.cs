...
public class RPG_Camera : MonoBehaviour {
    ...
    public float topDownDistance = 1;
    ...
    public void Init()
    {
        ...
        cameraPivot = GetObject.PlayerMonoGameObject.transform.FindChild("cameraPivot");
        Initialised = true;
    }
    ...
    void GetInput() {
        ...
        if (Input.GetMouseButton(1) && ((GetObject.PlayerController.CurrentAction == null) ||  GetObject.PlayerController.CurrentAction != null && !GetObject.PlayerController.CurrentAction.FaceQueueTarget))
        {
    ...
    {
        var cameraPiv = charTransform.FindChild("cameraPivot");
